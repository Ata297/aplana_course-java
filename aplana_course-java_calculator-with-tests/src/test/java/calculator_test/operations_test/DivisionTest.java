...
public class DivisionTest {
    ...
    @Test
    public void testPositiveWithFirstZero() {
        Scanner scanner = null;
        try {
            scanner = new Scanner(new File(fileRoot + "division-test_test-positive-with-first-zero.txt"));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        Division sub = new Division();
    ...
    public void testPositiveWithSecondZero() {
        Scanner scanner = null;
        try {
            scanner = new Scanner(new File(fileRoot + "division-test_test-positive-with-second-zero.txt"));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        Division sub = new Division();
